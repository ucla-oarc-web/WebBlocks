		...
		var modules = {
			...
			'Base/Color/Branding/Background': {
                ...
                uses: [
                    ...
                    'color-branding-default-background-text',
                    'color-branding-default-background-shadow',
                    'color-branding-default-border',
                    'color-branding-default-background-text-shadow',
                    'color-branding-primary-background-text',
                    'color-branding-primary-background-shadow',
                    'color-branding-primary-border',
                    'color-branding-primary-background-text-shadow',
                    'color-branding-secondary-background-text',
                    'color-branding-secondary-background-shadow',
                    'color-branding-secondary-border',
                    'color-branding-secondary-background-text-shadow',
                    'color-branding-tertiary-background-text',
                    'color-branding-tertiary-background-shadow',
                    'color-branding-tertiary-border',
                    'color-branding-tertiary-background-text-shadow',
                    'color-branding-neutral-background-text',
                    'color-branding-neutral-background-shadow',
                    'color-branding-neutral-border',
                    'color-branding-neutral-background-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Branding/Background_Gradient': {
                ...
                uses: [
                    ...
                    'color-branding-neutral',
                    'color-grade-lt',
                    'color-branding-default-background',
                    'color-branding-default-background-shadow',
                    'color-branding-primary-background',
                    'color-branding-primary-background-shadow',
                    'color-branding-secondary-background',
                    'color-branding-secondary-background-shadow',
                    'color-branding-tertiary-background',
                    'color-branding-tertiary-background-shadow',
                    'color-branding-neutral-background',
                    'color-branding-neutral-background-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Branding/Background_Light': {
                ...
                uses: [
                    ...
                    'color-branding-default-background-light-text',
                    'color-branding-default-background-light-shadow',
                    'color-branding-default-light-border',
                    'color-branding-default-background-light-text-shadow',
                    'color-branding-primary-background-light-text',
                    'color-branding-primary-background-light-shadow',
                    'color-branding-primary-light-border',
                    'color-branding-primary-background-light-text-shadow',
                    'color-branding-secondary-background-light-text',
                    'color-branding-secondary-background-light-shadow',
                    'color-branding-secondary-light-border',
                    'color-branding-secondary-background-light-text-shadow',
                    'color-branding-tertiary-background-light-text',
                    'color-branding-tertiary-background-light-shadow',
                    'color-branding-tertiary-light-border',
                    'color-branding-tertiary-background-light-text-shadow',
                    'color-branding-neutral-background-light-text',
                    'color-branding-neutral-background-light-shadow',
                    'color-branding-neutral-light-border',
                    'color-branding-neutral-background-light-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Branding/Background_Light_Gradient': {
                ...
                uses: [
                    ...
                    'color-branding-neutral',
                    'color-grade-lt',
                    'color-branding-default-background-light',
                    'color-branding-default-background-light-shadow',
                    'color-branding-default-background-light-text',
                    'color-branding-default-background-light-text-shadow',
                    'color-branding-primary-background-light',
                    'color-branding-primary-background-light-shadow',
                    'color-branding-primary-background-light-text',
                    'color-branding-primary-background-light-text-shadow',
                    'color-branding-secondary-background-light',
                    'color-branding-secondary-background-light-shadow',
                    'color-branding-secondary-background-light-text',
                    'color-branding-secondary-background-light-text-shadow',
                    'color-branding-tertiary-background-light',
                    'color-branding-tertiary-background-light-shadow',
                    'color-branding-tertiary-background-light-text',
                    'color-branding-tertiary-background-light-text-shadow',
                    'color-branding-neutral-background-light',
                    'color-branding-neutral-background-light-shadow',
                    'color-branding-neutral-background-light-text',
                    'color-branding-neutral-background-light-text'
                ],
			...
			'Base/Color/Branding/Background_Dark': {
                ...
                uses: [
                    ...
                    'color-branding-default-background-dark-text',
                    'color-branding-default-background-dark-shadow',
                    'color-branding-default-dark-border',
                    'color-branding-default-background-dark-text-shadow',
                    'color-branding-primary-background-dark-text',
                    'color-branding-primary-background-dark-shadow',
                    'color-branding-primary-dark-border',
                    'color-branding-primary-background-dark-text-shadow',
                    'color-branding-secondary-background-dark-text',
                    'color-branding-secondary-background-dark-shadow',
                    'color-branding-secondary-dark-border',
                    'color-branding-secondary-background-dark-text-shadow',
                    'color-branding-tertiary-background-dark-text',
                    'color-branding-tertiary-background-dark-shadow',
                    'color-branding-tertiary-dark-border',
                    'color-branding-tertiary-background-dark-text-shadow',
                    'color-branding-neutral-background-dark-text',
                    'color-branding-neutral-background-dark-shadow',
                    'color-branding-neutral-dark-border',
                    'color-branding-neutral-background-dark-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Branding/Background_Dark_Gradient': {
                ...
                uses: [
                    ...
                    'color-branding-neutral',
                    'color-grade-lt',
                    'color-branding-default-background-dark',
                    'color-branding-default-background-dark-shadow',
                    'color-branding-default-background-dark-text',
                    'color-branding-default-background-dark-text-shadow',
                    'color-branding-primary-background-dark',
                    'color-branding-primary-background-dark-shadow',
                    'color-branding-primary-background-dark-text',
                    'color-branding-primary-background-dark-text-shadow',
                    'color-branding-secondary-background-dark',
                    'color-branding-secondary-background-dark-shadow',
                    'color-branding-secondary-background-dark-text',
                    'color-branding-secondary-background-dark-text-shadow',
                    'color-branding-tertiary-background-dark',
                    'color-branding-tertiary-background-dark-shadow',
                    'color-branding-tertiary-background-dark-text',
                    'color-branding-tertiary-background-dark-text-shadow',
                    'color-branding-neutral-background-dark',
                    'color-branding-neutral-background-dark-shadow',
                    'color-branding-neutral-background-dark-text',
                    'color-branding-neutral-background-dark-text'
                ],
			...
			'Base/Color/Branding/Text': {
                ...
                uses: [
                    ...
                    'color-branding-default-text-brightness',
                    'color-branding-default-foreground-text',
                    'color-branding-primary-text-brightness',
                    'color-branding-primary-foreground-text',
                    'color-branding-secondary-text-brightness',
                    'color-branding-secondary-foreground-text',
                    'color-branding-tertiary-text-brightness',
                    'color-branding-tertiary-foreground-text',
                    'color-branding-neutral-text-brightness',
                    'color-branding-neutral-foreground-text'
                ],
				api:'Base/Color'
			},
			'Base/Color/Mood': {
			...
			'Base/Color/Mood/Background': {
                ...
                uses: [
                    ...
                    'color-grade-lt-text',
                    'color-contrast-threshold',
                    'color-mood-info-background-text',
                    'color-mood-info-background-shadow',
                    'color-mood-info-border',
                    'color-mood-info-background-text-shadow',
                    'color-mood-success-background-text',
                    'color-mood-success-background-shadow',
                    'color-mood-success-border',
                    'color-mood-success-background-text-shadow',
                    'color-mood-warning-background-text',
                    'color-mood-warning-background-shadow',
                    'color-mood-warning-border',
                    'color-mood-warning-background-text-shadow',
                    'color-mood-danger-background-text',
                    'color-mood-danger-background-shadow',
                    'color-mood-danger-border',
                    'color-mood-danger-background-text-shadow',
                    'color-mood-error-background-text',
                    'color-mood-error-background-shadow',
                    'color-mood-error-border',
                    'color-mood-error-background-text-shadow',
                    'color-mood-important-background-text',
                    'color-mood-important-background-shadow',
                    'color-mood-important-border',
                    'color-mood-important-background-text-shadow',
                    'color-mood-inverse-background-text',
                    'color-mood-inverse-background-shadow',
                    'color-mood-inverse-border',
                    'color-mood-inverse-background-text-shadow',
                    'color-mood-required-background-text',
                    'color-mood-required-background-shadow',
                    'color-mood-required-border',
                    'color-mood-required-background-text-shadow',
                    'color-mood-highlight-background-text',
                    'color-mood-highlight-background-shadow',
                    'color-mood-highlight-border',
                    'color-mood-highlight-background-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Mood/Background_Gradient': {
                ...
                uses: [
                    ...
                    'color-mood-highlight',
                    'color-grade-lt',
                    'color-mood-info-background',
                    'color-mood-info-background-shadow',
                    'color-mood-success-background',
                    'color-mood-success-background-shadow',
                    'color-mood-warning-background',
                    'color-mood-warning-background-shadow',
                    'color-mood-error-background',
                    'color-mood-error-background-shadow',
                    'color-mood-danger-background',
                    'color-mood-danger-background-shadow',
                    'color-mood-important-background',
                    'color-mood-important-background-shadow',
                    'color-mood-inverse-background',
                    'color-mood-inverse-background-shadow',
                    'color-mood-required-background',
                    'color-mood-required-background-shadow',
                    'color-mood-highlight-background',
                    'color-mood-highlight-background-shadow',
                ],
				requires: [
					'Base/Color/Mood/Background'
			...
			'Base/Color/Mood/Background_Light': {
                ...
                uses: [
                    ...
                    'color-light-border-brightness',
                    'color-contrast-threshold-light',
                    'color-mood-info-background-light-text',
                    'color-mood-info-background-light-shadow',
                    'color-mood-info-light-border',
                    'color-mood-info-background-light-text-shadow',
                    'color-mood-success-background-light-text',
                    'color-mood-success-background-light-shadow',
                    'color-mood-success-light-border',
                    'color-mood-success-background-light-text-shadow',
                    'color-mood-warning-background-light-text',
                    'color-mood-warning-background-light-shadow',
                    'color-mood-warning-light-border',
                    'color-mood-warning-background-light-text-shadow',
                    'color-mood-error-background-light-text',
                    'color-mood-error-background-light-shadow',
                    'color-mood-error-light-border',
                    'color-mood-error-background-light-text-shadow',
                    'color-mood-danger-background-light-text',
                    'color-mood-danger-background-light-shadow',
                    'color-mood-danger-light-border',
                    'color-mood-danger-background-light-text-shadow',
                    'color-mood-important-background-light-text',
                    'color-mood-important-background-light-shadow',
                    'color-mood-important-light-border',
                    'color-mood-important-background-light-text-shadow',
                    'color-mood-inverse-background-light-text',
                    'color-mood-inverse-background-light-shadow',
                    'color-mood-inverse-light-border',
                    'color-mood-inverse-background-light-text-shadow',
                    'color-mood-required-background-light-text',
                    'color-mood-required-background-light-shadow',
                    'color-mood-required-light-border',
                    'color-mood-required-background-light-text-shadow',
                    'color-mood-highlight-background-light-text',
                    'color-mood-highlight-background-light-shadow',
                    'color-mood-highlight-light-border',
                    'color-mood-highlight-background-light-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Mood/Background_Light_Gradient': {
                ...
                uses: [
                    ...
                    'color-mood-highlight',
                    'color-grade-lt',
                    'color-mood-info-background-light',
                    'color-mood-info-background-light-shadow',
                    'color-mood-info-background-light-text',
                    'color-mood-info-background-light-text-shadow',
                    'color-mood-success-background-light',
                    'color-mood-success-background-light-shadow',
                    'color-mood-success-background-light-text',
                    'color-mood-success-background-light-text-shadow',
                    'color-mood-warning-background-light',
                    'color-mood-warning-background-light-shadow',
                    'color-mood-warning-background-light-text',
                    'color-mood-warning-background-light-text-shadow',
                    'color-mood-error-background-light',
                    'color-mood-error-background-light-shadow',
                    'color-mood-error-background-light-text',
                    'color-mood-error-background-light-text-shadow',
                    'color-mood-danger-background-light',
                    'color-mood-danger-background-light-shadow',
                    'color-mood-danger-background-light-text',
                    'color-mood-danger-background-light-text',
                    'color-mood-important-background-light',
                    'color-mood-important-background-light-shadow',
                    'color-mood-important-background-light-text',
                    'color-mood-important-background-light-text-shadow',
                    'color-mood-inverse-background-light',
                    'color-mood-inverse-background-light-shadow',
                    'color-mood-inverse-background-light-text',
                    'color-mood-inverse-background-light-text-shadow',
                    'color-mood-required-background-light',
                    'color-mood-required-background-light-shadow',
                    'color-mood-required-background-light-text',
                    'color-mood-required-background-light-text-shadow',
                    'color-mood-highlight-background-light',
                    'color-mood-highlight-background-light-shadow',
                    'color-mood-highlight-background-light-text',
                    'color-mood-highlight-background-light-text'
                ],
			...
			'Base/Color/Mood/Background_Dark': {
                ...
                uses: [
                    ...
                    'color-dark-border-brightness',
                    'color-contrast-threshold-dark',
                    'color-mood-info-background-dark-text',
                    'color-mood-info-background-dark-shadow',
                    'color-mood-info-dark-border',
                    'color-mood-info-background-dark-text-shadow',
                    'color-mood-success-background-dark-text',
                    'color-mood-success-background-dark-shadow',
                    'color-mood-success-dark-border',
                    'color-mood-success-background-dark-text-shadow',
                    'color-mood-warning-background-dark-text',
                    'color-mood-warning-background-dark-shadow',
                    'color-mood-warning-dark-border',
                    'color-mood-warning-background-dark-text-shadow',
                    'color-mood-error-background-dark-text',
                    'color-mood-error-background-dark-shadow',
                    'color-mood-error-dark-border',
                    'color-mood-error-background-dark-text-shadow',
                    'color-mood-danger-background-dark-text',
                    'color-mood-danger-background-dark-shadow',
                    'color-mood-danger-dark-border',
                    'color-mood-danger-background-dark-text-shadow',
                    'color-mood-important-background-dark-text',
                    'color-mood-important-background-dark-shadow',
                    'color-mood-important-dark-border',
                    'color-mood-important-background-dark-text-shadow',
                    'color-mood-inverse-background-dark-text',
                    'color-mood-inverse-background-dark-shadow',
                    'color-mood-inverse-dark-border',
                    'color-mood-inverse-background-dark-text-shadow',
                    'color-mood-required-background-dark-text',
                    'color-mood-required-background-dark-shadow',
                    'color-mood-required-dark-border',
                    'color-mood-required-background-dark-text-shadow',
                    'color-mood-highdark-background-dark-text',
                    'color-mood-highdark-background-dark-shadow',
                    'color-mood-highdark-dark-border',
                    'color-mood-highdark-background-dark-text-shadow'
                ],
				api:'Base/Color'
			},
			'Base/Color/Mood/Background_Dark_Gradient': {
                ...
                uses: [
                    ...
                    'color-mood-highdark',
                    'color-grade-lt',
                    'color-mood-info-background-dark',
                    'color-mood-info-background-dark-shadow',
                    'color-mood-info-background-dark-text',
                    'color-mood-info-background-dark-text-shadow',
                    'color-mood-success-background-dark',
                    'color-mood-success-background-dark-shadow',
                    'color-mood-success-background-dark-text',
                    'color-mood-success-background-dark-text-shadow',
                    'color-mood-warning-background-dark',
                    'color-mood-warning-background-dark-shadow',
                    'color-mood-warning-background-dark-text',
                    'color-mood-warning-background-dark-text-shadow',
                    'color-mood-error-background-dark',
                    'color-mood-error-background-dark-shadow',
                    'color-mood-error-background-dark-text',
                    'color-mood-error-background-dark-text-shadow',
                    'color-mood-danger-background-dark',
                    'color-mood-danger-background-dark-shadow',
                    'color-mood-danger-background-dark-text',
                    'color-mood-danger-background-dark-text',
                    'color-mood-important-background-dark',
                    'color-mood-important-background-dark-shadow',
                    'color-mood-important-background-dark-text',
                    'color-mood-important-background-dark-text-shadow',
                    'color-mood-inverse-background-dark',
                    'color-mood-inverse-background-dark-shadow',
                    'color-mood-inverse-background-dark-text',
                    'color-mood-inverse-background-dark-text-shadow',
                    'color-mood-required-background-dark',
                    'color-mood-required-background-dark-shadow',
                    'color-mood-required-background-dark-text',
                    'color-mood-required-background-dark-text-shadow',
                    'color-mood-highdark-background-dark',
                    'color-mood-highdark-background-dark-shadow',
                    'color-mood-highdark-background-dark-text',
                    'color-mood-highdark-background-dark-text'
                ],
